;(function($){$.fn.deStickySection=function(options){var defaults={topSpacing:0,zIndex:'',stopper:$('.sticky-stopper'),stickyClass:false};var settings=$.extend({},defaults,options);function checkIndex(){if(typeof settings.zIndex=='number'){return true;}else{return false;}}
